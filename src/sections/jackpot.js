...
const JACKPOT_DATA = [
  {
    image: jackpotImage1,
    text:
      'We offer you a unique design and an attractive user experience.',
    heading: 'Smart Features',
  },
  {
    image: jackpotImage2,
    text:
      'We guarantee the security of your data and that of your customers.',
